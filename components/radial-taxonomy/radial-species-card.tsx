...
export function SpeciesCard({ data, onClose }: SpeciesCardProps) {
  ...
  //   const track = async () => {
  //     try {
  //       await trackSpeciesView(data.id)
  //     } catch (error) {
    ...
    >
      <div className="relative h-64 sm:h-56 w-full overflow-hidden">
        <img
          src={
            isGenus
              ? data.url_gambar || "https://i.postimg.cc/Lnrjd6jQ/Chat-GPT-Image-May-22-2025-01-54-09-AM.png"
              : species.url_gambar || species.image_url || "https://i.postimg.cc/Lnrjd6jQ/Chat-GPT-Image-May-22-2025-01-54-09-AM.png"
          }
          ...
          <>
            <TabsContent value="habitat" className="space-y-4">
              ...
              >
                ...
                {!isGenus && species && (<div className="bg-emerald-50/50 backdrop-blur-sm p-3 rounded-xl border border-emerald-100">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {!isGenus && species?.additionalImages?.map((images, i) => (
                      <div key={i} className="aspect-square rounded-lg overflow-hidden relative group">
                        <img
                          src={images.url || `https://i.postimg.cc/Lnrjd6jQ/Chat-GPT-Image-May-22-2025-01-54-09-AM.png`}
                          alt={`Gambar ${i}`}
